...
public class Game extends Application {
    ...
    public void start(Stage startUpStage) {
        ...
        gameLayoutLeft.getChildren().addAll(playerInfo, playerImage);
...
//                AlertBox.nextLevelAlert();
    ...
    public void changeLevel() {
        ...
        // TO DO: change 12 to the amount of time remaining 
        playerOfChoice.setScore(Score.increaseScore(playerOfChoice.getScore(), 12));
    }
}
